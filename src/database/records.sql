...
insert into assignment(title,descr,db,ui,submission,teachesId) values ("Mergesort","Test MergeSort Algo",'none','cli',"2019-04-04",2);
insert into cli values("merge", 1);
